<?php /* Smarty version 2.6.26, created on 2018-12-18 14:59:04
...
" id="pagesize" />
                <input type="text" class="input-text" style="width:200px" placeholder="用户名" name="name" value="<?php echo $this->_tpl_vars['name']; ?>
">
