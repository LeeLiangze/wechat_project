<?php /* Smarty version 2.6.26, created on 2018-12-18 14:58:29
...
">
        <input type="button" class="btn btn-primary radius" id="syj" value="返回上一级" onclick="javascript :history.back(-1);" <?php if (! $this->_tpl_vars['level']): ?> style="display: none;"<?php endif; ?> />
...
" style="width: 50px;height:50px;"/><?php else: ?><span>暂无图片</span><?php endif; ?></td>
                    ...
                    <td style="width: 180px;" >
						...
						<a style="text-decoration:none" class="ml-5" href="javascript:void(0);" onclick="on_top(this,'<?php echo $this->_tpl_vars['item']->cid; ?>
...
" title="修改" >
                        ...
                        <a style="text-decoration:none;width: 44%;" class="ml-5" href="index.php?module=product_class&action=add&cid=<?php echo $this->_tpl_vars['item']->cid; ?>
" title="在此分类下添加" >
                        	<div style="align-items: center;font-size: 12px;display: flex;">
                            	<div style="margin:0 auto;;display: flex;align-items: center;"> 
						...
						<a style="text-decoration:none;width: 44%;" class="ml-5" href="index.php?module=product_class&action=Index&cid=<?php echo $this->_tpl_vars['item']->cid; ?>
" title="查看该分类的下级" >
                        	<div style="align-items: center;font-size: 12px;display: flex;">
                            	<div style="margin:0 auto;;display: flex;align-items: center;"> 
