<?php /* Smarty version 2.6.26, created on 2018-12-18 09:54:21
...
" id="product_title" placeholder="请输入产品名称" style="width:200px" class="input-text">
...
"></label>
                                        ...
                                        <td style="min-width: 70px;"><?php if ($this->_tpl_vars['item']->img != ''): ?><span>暂无图片</span><?php else: ?><img onclick="pimg(this)" style="width: 50px;height: 50px;" src="../LKT/images/<?php echo $this->_tpl_vars['item']->imgurl; ?>
"><?php endif; ?></td>
...
<?php echo $this->_tpl_vars['item']->unit; ?>
                    ...
                    <td style="min-width: 70px;"><?php echo $this->_tpl_vars['item']->add_date; ?>
</td>
