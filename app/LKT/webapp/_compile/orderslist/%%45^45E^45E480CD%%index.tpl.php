<?php /* Smarty version 2.6.26, created on 2018-12-18 13:16:24
...
" <?php if ($this->_tpl_vars['otype'] == $this->_tpl_vars['key']): ?>selected<?php endif; ?>><?php echo $this->_tpl_vars['item']; ?>
			...
			<select name="brand" class="select" style="width: 120px;height: 31px;vertical-align: middle;">
				...
				<?php echo $this->_tpl_vars['brand_str']; ?>

			</select>

			<input type="text" name="sNo" size='8' value="<?php echo $this->_tpl_vars['sNo']; ?>
" id="" placeholder=" 订单编号或收件人姓名/电话..." style="width:200px" class="input-text">
		...
		<table class="table table-bordered bg-white">
			...
			<tr class="txc">
				...
				<th style="width: 170px;">订单号
					<!--<span style="font-size: 12px;">订单数: <?php echo $this->_tpl_vars['data1']['num']; ?>
 订单金额: <?php echo $this->_tpl_vars['data1']['numprice']; ?>
元 </span>-->
				</th>
...
?>
				<tr>
					...
					<td>
						<span><?php echo $this->_tpl_vars['item']->sNo; ?>
</span>
					</td>
					<td class="imgTd">
...
?>
							<div >
								<img class="goods-pic" src="<?php echo $this->_tpl_vars['uploadImg']; ?>
...
if ($this->_foreach['f2']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['item2']):
        $this->_foreach['f2']['iteration']++;
?>
							<span style="text-align: left;"><?php echo $this->_tpl_vars['item2']->product_title; ?>
</span>
						<?php endforeach; endif; unset($_from); ?>
					</td>
					<td>
					...
					<td>
						...
						<div>
							<span style=""><?php echo $this->_tpl_vars['item']->status; ?>
</span>
						</div>
					</td>
					<td>
						<div>
								<span>
									<?php if ($this->_tpl_vars['item']->pay == 'wxPay'): ?>微信支付
									<?php elseif ($this->_tpl_vars['item']->pay == 'wallet_Pay'): ?>余额支付
									<?php elseif ($this->_tpl_vars['item']->pay == 'consumer_pay'): ?>消费金支付
					...
					<td>
						<div>
							<span ><?php if ($this->_tpl_vars['item']->otype == 'pt'): ?>拼团订单<?php else: ?><?php if ($this->_tpl_vars['item']->drawid > 0): ?>抽奖订单<?php else: ?>普通订单<?php endif; ?><?php endif; ?></span>
						</div>
					</td>
					<td>
						<div  class="goods-name">
							<span ><?php echo $this->_tpl_vars['item']->user_name; ?>
</span>
						</div>
					</td>
					<td>
						<div style="text-align: center;">
							<span ><?php if ($this->_tpl_vars['item']->source == 1): ?>小程序<?php else: ?>APP<?php endif; ?></span>
						</div>
					</td>
					<td>
						<div style="text-align: center;">
							<span ><?php echo $this->_tpl_vars['item']->add_time; ?>
</span>
						</div>
					</td>
					<td  style="text-align: center;width: 80px;">
						<?php if ($this->_tpl_vars['item']->statu == 1): ?>
							<a class="btn send-btn" href="javascript:void(0);" onclick=send_btn(this,'<?php echo $this->_tpl_vars['item']->otype; ?>
','<?php echo $this->_tpl_vars['item']->sNo; ?>
',<?php echo $this->_tpl_vars['item']->statu; ?>
,<?php echo $this->_tpl_vars['item']->drawid; ?>
)> 发货</a>
						<?php endif; ?>
						<?php if ($this->_tpl_vars['item']->statu >= 2): ?>
							<a class="btn send-btn1" href="javascript:void(0);" onclick="send_btn1(this,'<?php echo $this->_tpl_vars['item']->sNo; ?>
','<?php echo $this->_tpl_vars['item']->products[0]->courier_num; ?>
')" >查看物流</a>
						<?php endif; ?>
						<a class="btn" style="margin-top: 5px;" href="index.php?module=orderslist&action=Detail&id=<?php echo $this->_tpl_vars['item']->id; ?>
">查看详情</a>
						<br>
					</td>
				</tr>
