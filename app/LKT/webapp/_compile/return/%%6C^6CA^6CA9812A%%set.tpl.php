<?php /* Smarty version 2.6.26, created on 2018-12-18 14:59:18
        ...
        <div id="tab-system" class="HuiTab">
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-6">
                    <input type="text" name="name" value="<?php echo $this->_tpl_vars['list']->name; ?>
" class="input-text">
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-6">
                    <input type="text" name="tel" value="<?php echo $this->_tpl_vars['list']->tel; ?>
" class="input-text">
                </div>
            </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-6">
                    <input type="text" name="address" value="<?php echo $this->_tpl_vars['list']->address; ?>
" class="input-text">
                </div>
            </div>
