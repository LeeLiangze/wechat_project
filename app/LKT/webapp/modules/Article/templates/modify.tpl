...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe616;</i> 文章管理 <span class="c-gray en">&gt;</span> 文章列表管理 <span class="c-gray en">&gt;</span> 修改文章 <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="#" onclick="location.href='index.php?module=Article';" title="关闭" ><i class="Hui-iconfont">&#xe6a6;</i></a></nav>
<div class="pd-20">
