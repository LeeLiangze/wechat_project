...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe616;</i> 系统管理 <span class="c-gray en">&gt;</span> 系统设置 <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
    ...
    <form name="form1" action="index.php?module=system" class="form form-horizontal" method="post"   enctype="multipart/form-data" >
        ...
        <div id="tab-system" class="HuiTab">
            ...
            <div class="row cl">
                ...
                <label class="form-label col-xs-4 col-sm-4"><span class="c-red">*</span>小程序api域名：</label>
            ...
            <input type="hidden" name="uploadImg" value="{$uploadImg}" class="input-text">
             <input type="hidden" name="upload_file" value="{$upload_file}" class="input-text">
<!--             <div class="row cl">
