...
// setAttribute() 设置一个属性。
    ...
    public function getDefaultView() {
        ...
        $request->setAttribute("authorization",$authorization);//--待发货
    ...
    public function upgrade()
    {
        ...
        $request = $this->getContext()->getRequest();
        $version = LKT_VERSION;
        https://dorisdouzi.cn/LKT/index.php?module=api&action=upgrade&type=2&software_version=0&version='.$version;
