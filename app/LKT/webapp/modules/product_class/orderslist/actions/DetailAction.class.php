...
class DetailAction extends Action {
    ...
    public function getDefaultView() {
      ...
      $sql = 'select l.sNo,l.name,l.mobile,l.sheng,l.shi,l.z_price,l.xian,l.address,l.drawid,d.user_id,d.p_id,d.p_name,d.p_price,d.num,d.unit,d.add_time,d.deliver_time,d.arrive_time,d.r_status,d.content,d.express_id,d.courier_num from lkt_order_details as d left join lkt_order as l on l.sNo=d.r_sNo where l.id="'.$id.'"';
      ...
      foreach ($res as $k => $v) { 
        ...
        if(!empty($drawid)&& $drawid !=0){
          ...
          $sql07 = "select * from lkt_draw_user where draw_id = '$drawid' and user_id = '$user_id' and time = '$add_time' ";
