...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe616;</i> 优惠券管理 <span class="c-gray en">&gt;</span> 优惠券参数 <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
    <form name="form1" action="index.php?module=orderslist&action=config" class="form form-horizontal" method="post"   enctype="multipart/form-data" >
        <div id="tab-system" class="HuiTab">
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-4">承若天数：</label>
            ...
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-4">承若内容：</label>
                <div class="formControls col-xs-8 col-sm-4">
            ...
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-4">未付款订单保留时间：</label>
                <div class="formControls col-xs-8 col-sm-4">
                    <input type="text" name="order_overdue" value="{$order_overdue}" class="input-text">
                    <text>如：生成订单,2天内没付款,删除订单. 0 表示不删除</text>
                </div>
