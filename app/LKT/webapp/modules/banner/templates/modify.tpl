...
<div class="pd-20">
    ...
    <form name="form1" action="index.php?module=banner&action=modify&id={$id}" class="form form-horizontal" method="post" enctype="multipart/form-data" >

      <input type="hidden" name="uploadImg" value="{$uploadImg}" >

      <div class="row cl">

        <label class=""><span class="c-red">*</span>轮播图：</label>
