...
<nav class="breadcrumb" style="    line-height: 3;"><i class="Hui-iconfont">&#xe646;</i> 轮播图管理 <span class="c-gray en">&gt;</span> 轮播图 <span class="c-gray en">&gt;</span> 修改轮播图 <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px;float: right;" href="#" onclick="location.href='index.php?module=banner';" title="关闭" ><i class="Hui-iconfont">&#xe6a6;</i></a></nav>

<div class="pd-20">

    <form name="form1" action="index.php?module=banner&action=add" class="form form-horizontal" method="post" enctype="multipart/form-data" >
    ...
    <div class="row cl">
      ...
      <label ><span class="c-red">*</span>轮播图：</label>
      ...
      <div class="row cl">
        ...
        <div class="">
          ...
          <input type="text" class="input-text" value="" placeholder="" id="banner_url" name="url" style="width: 80%;">
