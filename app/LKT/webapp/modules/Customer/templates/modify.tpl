...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe687;</i> 客户管理 <span class="c-gray en">&gt;</span> 客户信息修改 <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="index.php?module=Customer" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="pd-20">
    <form name="form1" action="index.php?module=Customer&action=modify&id={$customer->id}" class="form form-horizontal" method="post" enctype="multipart/form-data" >
        <input type="hidden" name="id" value="{$customer->id}">
        <div class="row cl">
            <label class="form-label col-2"><span class="c-red"></span>客户名称：</label>
            <div class="formControls col-10">
                <input type="text" class="input-text" value="{$customer->name}" placeholder="" id="" name="name">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-2"><span class="c-red"></span>公司名称：</label>
            <div class="formControls col-10">
                <input type="text" class="input-text" value="{$customer->company}" placeholder="" id="" name="company">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-2"><span class="c-red"></span>客户编号：</label>
            <div class="formControls col-10">
                <input type="text" class="input-text" value="{$customer->user_id}" placeholder="" id="" name="user_num">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-2"><span class="c-red"></span>手机号：</label>
            <div class="formControls col-10">
                <input type="text" class="input-text" value="{$customer->mobile}" placeholder="" id="" name="phone">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-10">
               <select name="product_type" class="select input-text">
                    <option value='2' {if $customer->function == '2'} selected="selected" {/if}>运营版</option>
                    <option value='3' {if $customer->function == '3'} selected="selected" {/if}>商业版</option>
               </select>
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-10">
                <input type="text" class="input-text" value="{$customer->price}" name="price">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-10">
                <input type="text" class="input-text" value="{$customer->email}" placeholder="" id="" name="email">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-10">
                <input name="endtime" size="8" value="{$customer->end_date}" readonly  class="scinput_s" style="height:26px;font-size: 14px;vertical-align: middle;"/>
        ...
        <input type="hidden" name="status" class="s_status" value="{$customer->status}">
    </form>
</div>
