...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe646;</i> app引导图管理 <span class="c-gray en">&gt;</span> 引导图 <span class="c-gray en">&gt;</span> 添加引导图 <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="#" onclick="location.href='index.php?module=guide';" title="关闭" ><i class="Hui-iconfont">&#xe6a6;</i></a></nav>
<div class="pd-20">
  <form name="form1" action="index.php?module=guide&action=add" class="form form-horizontal" method="post" enctype="multipart/form-data" >
    <div class="row cl">
