...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe705;</i> 用户管理 <span class="c-gray en">&gt;</span> 用户列表管理 <span class="c-gray en">&gt;</span> 用户信息详情 
	<a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="#" onclick="location.href='index.php?module=userlist';" title="关闭" ><i class="Hui-iconfont">&#xe6a6;</i></a>
