...
<body>
<div class="breadcrumb"><i class="Hui-iconfont">&#xe616;</i> 产品管理 <span class="c-gray en">&gt;</span> 产品列表管理 <span class="c-gray en">&gt;</span> 修改产品 <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="#" onclick="location.href='index.php?module=product';" title="关闭"><i class="Hui-iconfont">&#xe6a6;</i></a></div>
<div class="pd-20">
    <form name="form1" action="index.php?module=product&action=modify" enctype="multipart/form-data" method="post">
        ...
        <div class='row cl' style='width: 95%;padding-left: 100px;'>
            <table id='table' class='table table-border table-bordered table-bg' style='width: 98%;margin-left: 20px;'>
                <thead id='thead'>
                <tr id='attribute_0' >
                ...
                {foreach from=$attribute_val item=item1 key=k name=f2}
                    <tr class='num' id='tr_{$k+1}'>
                        {foreach from=$item1 item=item2 name=f3}
                            {if $smarty.foreach.f3.last}
                                <td><image src='{$item2}' style='height:50px;width:50;' /></td>
                            {else}
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-8 skin-minimal">
                <div class="radio-box">
                    <input name="s_type[]" type="checkbox" id="sex-1" value="1" {if in_array(1,$s_type)}checked="checked"{/if}>
                    <label for="sex-1">新品</label>
                </div>
                <div class="radio-box">
                    <input type="checkbox" id="sex-2" name="s_type[]" value="2" {if in_array(2,$s_type)}checked="checked"{/if}>
                    <label for="sex-2">热销</label>
                </div>
                <div class="radio-box">
                    <input type="checkbox" id="sex-3" name="s_type[]" value="3" {if in_array(3,$s_type)}checked="checked"{/if}>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-10" style="width: 20%;">
                <input type="hidden" id="picurl1" value="{$uploadImg}{$imgurl}" class="td-input" name="image"/>
                <input type="hidden" name="img_oldpic" value="{$imgurl}" >
                <img id="thumb_url1" src='{$uploadImg}{$imgurl}' style="height:50px;width:50">
                <span class="btn btn-success image1"  type="button" >选择图片</span>
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-10">
                <div class="uploader-thum-container">
                    <input name="imgurls[]"  multiple='multiple' type="file" style="width:210px;" accept="upload_image/x-png,image/gif,image/jpeg" />
                    {if $imgurls != ''}
