        ...
        <table class="table table-border table-bordered table-bg table-hover table-sort">
            ...
            {foreach from=$list item=item name=f1}
                <tr class="text-c">
                    ...
                    <td>{$item->url}</td>
                    <td>{$item->add_time}</td>
                    <td>{if $item->type == 0}<span style="color: #ff2a1f;">未启用</span>{elseif $item->type == 1}<span style="color: #30c02d;">启用</span>{/if}</td>
                    <td>
                        {if $item->type == 0}
                        ...
                        {if $item->id ==5}
                        <a style="text-decoration:none" class="ml-5" href="index.php?module=draw" title="参数" ><i class="Hui-iconfont">&#xe6c6;</i></a>
                        {else}
                            {if $item->http != ''}
                            <a style="text-decoration:none" class="ml-5" href="index.php?module={$item->http}&action=config&id={$item->id}" title="参数" ><i class="Hui-iconfont">&#xe6c6;</i></a>
                            {/if}
                        {/if}
