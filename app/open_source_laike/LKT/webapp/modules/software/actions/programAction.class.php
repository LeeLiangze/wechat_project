...
class programAction extends Action {
	...
	public function getDefaultView() {
        ...
        $sql = "select * from lkt_software where type = '0' order by id desc";
        ...
        $upload_file = $r_1[0]->upload_file; // 图片上传位置
        ...
        $request->setAttribute("upload_file",$zip);
...

    {
        ...
        $sql = "select * from lkt_software where type = '$select_type' and version='$select_version' order by id desc";
